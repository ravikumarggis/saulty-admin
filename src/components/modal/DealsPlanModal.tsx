...
const DealsPlanModal: React.FC<CreateCategoryModalProps> = ({
  isOpen,
  onClose,
  selectedData,
  text,
          ...
          {selectedData?.depositData && (
            <div className="border w-full rounded-md p-2 flex flex-col space-y-2 ">
              ...
              <div className="flex justify-between items-center">
                ...
                <span>{selectedData?.depositData?.depositAmount || "--"}</span>
              </div>
              <div className="flex justify-between items-center">
                <span>Symbol:</span>
            ...
            {Number(selectedData?.allocateQty) > 0 && (
              <>
                <div className="flex justify-between items-center">
                  ...
                  <span>
                    {`${selectedData?.allocateQty} ${selectedData?.dealPlan?.symbol}` ||
                      "--"}
                  </span>
                </div>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span>
                    {selectedData?.dealPlan?.resultDate
                      ?
                      DateTimeFormates(selectedData?.dealPlan?.resultDate)

                      // moment(selectedData?.dealPlan?.resultDate).format("lll")
                      : "--"}{" "}
                  </span>
                </div>
              </>
