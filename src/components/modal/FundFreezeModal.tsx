...
const FundFreezeModal: React.FC<Props> = ({
    isOpen,
    onClose,
    title = "Details",
    selecteddata,
    ...
    const planDetails = useMemo(() => { return selecteddata }, [selecteddata]);
    ...
    const columns = [
        ...
        columnHelper.accessor("date", {
            ...
            cell: (info) => info.getValue() ? moment(info.getValue())?.format("llll") : "--",
        }),
...
export default FundFreezeModal;
