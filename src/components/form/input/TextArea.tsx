...
const TextArea: React.FC<TextareaProps> = ({
  ...
  if (disabled) {
    textareaClasses += `bg-gray-100 opacity-500 text-gray-500 border-gray-300 cursor-not-allowed opacity40 dark:bg-black dark:text-gray-400 dark:border-gray-700`;
  } else if (error) {
