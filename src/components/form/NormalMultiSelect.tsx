...
const NormalMultiSelect: React.FC<NormalMultiSelect> = ({
    label,
    options,
    defaultSelected = [],
    value,
    ...
    return (
        <div className="w-full max-h-10" ref={dropdownRef}>
            <label
            ...
            <div className="relative z-20 inline-block w-full">
                <div className="relative flex flex-col items-center">
                    ...
                    {isOpen && (
                        <div
                            className="absolute left-0 z-999 w-full overflow-y-auto bg-white rounded-lg shadow-sm top-full max-h-select dark:bg-gray-900  max-h-96"
                        ...
                        >
                            {options?.map((option, index) => {
                                ...
                                return (
                                    <div
                                        key={option.value}
                                        className={`h-auto hover:bg-primary/5 w-full cursor-pointer rounded-t border-b border-gray-200 dark:border-gray-800 ${isFocused ? "bg-primary/5" : ""
